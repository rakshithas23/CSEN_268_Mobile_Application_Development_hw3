  ...
  void _loadBooks(LoadBooks event, Emitter<BookState> emit) {
    allBooks = [
      const Book(
        ...
        imageUrl: 'https://covers.openlibrary.org/b/id/12716726-M.jpg',
      ),
      const Book(
        id: '2',
      ...
      const Book(
        ...
        imageUrl: 'https://covers.openlibrary.org/b/id/10624058-M.jpg',
      ),
      const Book(
        id: '4',
        title: 'Circe',
        ...
        imageUrl: 'https://covers.openlibrary.org/b/id/8737739-M.jpg',
      ),
      const Book(
        id: '5',
        ...
        imageUrl: 'https://covers.openlibrary.org/b/id/8739355-M.jpg',
      ),
      const Book(
        id: '6',
        title: 'Normal People',
        ...
        imageUrl: 'https://covers.openlibrary.org/b/id/9264645-M.jpg',
      ),
    ];
    add(SortByAuthor());
  }
